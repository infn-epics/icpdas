...
drvAsynIPPortConfigure("ICPDAS_IP", "192.168.104.47:502", 0, 0, 0)
...
drvModbusAsynConfigure("ICPDAS_DO", "ICPDAS_IP", 1, 5, 0, 1, 0, 1000, "ICPDAS7060")
...
dbLoadRecords("$(TOP)/db/icp7060.db","P=ICPDAS,R=Test7060,get_port=ICP_get_port,set_port=ICP_set_port, CNTPORT=ICP_DICNT,DIPORT=ICP_DI, PORT=ICP_info_port,DOPORT=ICPDAS_DO")
