...
drvModbusAsynConfigure("ICP_DOR", "ICPDAS_IP", 1, 1, 0, 6, 0, 1000, "ICPDAS7250")
...
dbLoadRecords("$(TOP)/db/icpdo.template","P=ICPDAS,R=Test7267,PORT=ICP_DO,PORTR=ICP_DOR, ID=0")
